...
@Testcontainers
@SpringBootTest(classes = MailAnalyzerApplication.class, webEnvironment = WebEnvironment.RANDOM_PORT)
class MailAnalyzerApplicationLiveTest {
...
//sachin@com.mail @scchin sachin@mail
    ...
    private void createConsumer() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "slabstech");
